        ...
        <div className="sec">
          <div className="industry-cta-box">
            ...
            <div className="btn-row">
              <Button variant="primary" onClick={() => alert('Contact functionality will be connected to API')}>{cta.buttonText}</Button>
              <Button variant="secondary" onClick={() => navigate('/white-papers')}>{cta.secondaryButtonText}</Button>
            </div>
          </div>
        </div>
      </div>
